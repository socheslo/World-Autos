...
//Створення абстрактного класу Car
abstract class Vehicle implements FormattedAccess {
    ...
    function getFormattedMileage() {
        return number_format($this->mileage, 2);
    }
    function getFormattedPrice() {
        return number_format($this->price, 2);
    }
    function getOptions() {
        return "(No additional optins)";
    }
}
...
// Успадкування створення нового класу який наслідується від класу транспортного засобу
